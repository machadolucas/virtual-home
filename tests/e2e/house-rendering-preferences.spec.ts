...
import { openHouseSession, openRenderingCategory, waitForStableFrames } from "./helpers/house";

test("rendering choices survive reload and reset without saving camera or edits", async ({ browser }) => {
