...
cd "$APP_DIR"
# The pid survives the exec below, so $DATA_DIR/run/web.pid names the node process launchd supervises.
vh_write_pidfile "$DATA_DIR" web
